...
csv_data = pd.read_csv("./sales_data_sample_2.csv", encoding="cp1252")
excel_data = pd.read_excel("./sales_data_sample_2.xlsx")
json_data = pd.read_json("./sales_data_sample_2.json", lines=True)
